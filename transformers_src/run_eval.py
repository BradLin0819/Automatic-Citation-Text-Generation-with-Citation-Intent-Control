...
# This code is adapted from https://github.com/huggingface/transformers/blob/v4.2.2-patch/examples/seq2seq/run_eval.py
...
def run_generate(verbose=True):
    ...
    parser.add_argument("--grid_search", action="store_true",
                        help="hyperparameter search (beam size and length penalty)")
    parser.add_argument(
        "--info",
        nargs="?",
        type=str,
    ...
    runtime_metrics = generate_summaries_or_translations(
        ...
        args.save_path,
        args.model_name,
        model_state_dict_path=args.pretrained_model_path,
        batch_size=args.bs,
        device=args.device,
        fp16=args.fp16,
        task=args.task,
